...
<div class="wrapper" style="zoom:90%" !important>
  <?php
    if (isset($_POST['tambahdata']))
    {
      ...
      $querycek_klsmk =  mysqli_query($con, "SELECT * FROM tbl_klsmatkul WHERE kode_matkul='$kode_mk' AND nid='$nid' AND id_periode='$id_periode' AND kelas='$kelas' AND kode_jurusan='$jurusan' ") or die (mysqli_eror($con));
